...
const thefieldname=(fieldname=='توضیح کوتاه')?productinfo.synopsis :productinfo.description
...
<Textarea className="w-[40vw]" name={fieldname}  value={Editinput} onChange={(e)=>setEditinput(e.target.value)} />  
</div> 
