...
export default function Categoryfilter() {
  ...
  const mutation = useAPostcategoryimage(categoryvalue, categoryimageurl);
  ...
  async function uploadfile(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    try {
      ...
      setcategoryimageurl(permanentSignedUrl);
    ...
    <div dir="rtl" className="md:pt-16">
      <div className="bg-white p-4  md:w-[90%] min-h-[100vh] md:mx-auto md:rounded-md">
        ...
        <div className="flex mb-2">
          <p>اضافه کردن عکس:{categoryvalue}</p>
          {categoryimageurl && <CheckIcon className="text-green-600" />}
          <Input
            className="w-[50%]"
            type="file"
            onChange={uploadfile}
